...
const projectMilestones = [
  {
    name: "Đoạn Ngầm",
    progress: 95,
    details: "Hoàn thành đào hầm và lắp đặt ray"
  },
  {
    name: "Đoạn Trên Cao",
    progress: 98,
    details: "Hoàn thành trụ cầu và lắp đặt ray trên cao"
  },
  {
    name: "Nhà Ga",
    progress: 92,
    details: "Hoàn thành kết cấu và đang hoàn thiện nội thất"
  },
  {
    name: "Hệ Thống Vận Hành",
    progress: 85,
    details: "Đang lắp đặt các thiết bị điều khiển và hệ thống tín hiệu"
  }
];
...
const timelineEvents = [
  {
    date: "Q2/2024",
    title: "Hoàn thành lắp đặt hệ thống",
    description: "Hoàn thành toàn bộ hệ thống điện, tín hiệu, và các thiết bị vận hành"
  },
  {
    date: "Q3/2024",
    title: "Chạy thử nghiệm toàn tuyến",
    description: "Chạy thử nghiệm toàn tuyến với đủ các đoàn tàu"
  },
  {
    date: "Q4/2024",
    title: "Đánh giá an toàn",
    description: "Tiến hành đánh giá an toàn và hiệu quả vận hành"
  },
  {
    date: "Q1/2025",
    title: "Vận hành thử",
    description: "Vận hành thử với hành khách giới hạn"
  },
  {
    date: "Q4/2025",
    title: "Vận hành thương mại",
    description: "Đưa vào vận hành thương mại chính thức"
  }
];
