// fare.config.js
const stationOrder = [
  'Bến Thành', 'Nhà hát Thành phố', 'Ba Son', 'Công viên Văn Thánh', 'Tân Cảng', 'Thảo Điền',
  'An Phú', 'Rạch Chiếc', 'Phước Long', 'Bình Thái', 'Thủ Đức',
  'Khu Công nghệ cao', 'Đại học Quốc gia', 'Bến xe Suối Tiên'
];
